            ...
            child: Center(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: const Color.fromARGB(255, 235, 165, 61)),
                      ),
                    ),
                    cursorColor: const Color.fromARGB(255, 0, 255, 179), // Set the cursor color to orange
                  ),
                  ...
                  Divider(thickness: 5, color: Color.fromARGB(255, 162, 0, 255)),
                  ...
                  Text('Province: $city', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),),
                ],
              ),
            ),
          ),
